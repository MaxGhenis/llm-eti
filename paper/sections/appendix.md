...
shown. Encoded as UTF-8 with LF line endings and no trailing LF, the text from
the first `Y` through the closing `}` has SHA-256
...
Claude Haiku 4.5 and DeepSeek V3 received the common template followed by
